                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="datable_1" class="table  display table-hover mb-30">
                                            ...
                                            {{-- {{dd($data->image)}} --}}
                                                <tr>
                                                    <td><img src="{{asset('storage/'.$data->image)}}" alt="" width="20%"></td>
                                                    <td>{{$data->desc}}</td>
                                                    <td>{{$data->category}}</td>
                                                    <td>{{$data->user->name}}</td>
                                                    <td>
                                                         <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#edit-banner-modal{{$data->id}}">Edit</button>
                                                         @include('admin.modal.edit-banner')
                                                    </td>
                                                </tr>
                                            @endforeach
